...
N = pd.read_csv("/home/zhangdi24/gru_ode_bayes/data_preproc/NYCtaxi/data/NYCtaxi_2017_01-03_irregular_region_1_80_norm.csv")["ID"].nunique()
...
for fold in range(Nfolds):
    ...
    fold_dir = f"/home/zhangdi24/gru_ode_bayes/gru_ode_bayes/datasets/NYCtaxi/folds/small_chunk_fold_idx_{fold}/"
